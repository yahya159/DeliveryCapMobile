package com.company.mysapbtpsdkproject.util
...
//            val oldValue = existingEntity.getDataValue(property)
    ...
    fun convert(
        ...
        return when (property.type) {
            ...
            BasicType.GEOMETRY_MULTI_POINT -> toGeometryMultiPoint(value)
            BasicType.GEOMETRY_LINE_STRING -> toGeometryLineString(value)
            BasicType.GEOMETRY_MULTI_LINE_STRING -> toGeometryMultiLineString(value)
            BasicType.GEOMETRY_POLYGON -> toGeometryPolygon(value)
            BasicType.GEOMETRY_MULTI_POLYGON -> toGeometryMultiPolygon(value)
